...
vertigo_ct['round_winner'] = vertigo_ct['round_winner'].replace(map_round_winner_ct)


cols_to_keep_ct = []
for col in vertigo_ct.columns:
...
vertigo_ct = vertigo_ct[cols_to_keep_ct]



plota_matriz_correlacao(vertigo_ct)
plt.matshow(vertigo_ct.corr(method='pearson'))
plt.show()
